...
int main(){
	...
	STDtest std("/home/omri/CLionProjects/Advanced Programming/input.txt","output.txt");
	CLI cli(&std);
	cli.start();
	std.close();
	check("output.txt","/home/omri/CLionProjects/Advanced Programming/expectedOutput.txt");
	cout<<"done"<<endl;
	return 0;
}
